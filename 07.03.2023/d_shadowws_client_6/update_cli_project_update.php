...
$id = $_GET['id'];
$error_date = $_POST['update_date'];
$error_updater_name = $_POST['updater_name'];
$error_title = $_POST['update_title'];
$desp = $_POST['desp'];
...
$sql = "UPDATE project_update SET update_date='$error_date', updater_name='$error_updater_name', update_title='$error_title', desp='$desp', client='$user_id' WHERE id='$id'";
