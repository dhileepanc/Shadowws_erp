...
if($_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  echo json_encode(["project_name" => $_SESSION['project_name'],'project_id' => $_SESSION['project_id'],'deadline' => $_SESSION['deadline'],'project_leader_name' => $_SESSION['project_leader_name'],'team' => $_SESSION['team']]);
}
else{
